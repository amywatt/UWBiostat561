...
# this is assuming your UWBiostat561 package was installed into your home directory on Bayes!
ggplot2::ggsave(plot_all, file = "~/UWBiostat561/vignettes/hw4-demo_bayes_plot.png",
