...
- 2 (n) x 2 (clique frac) x 2 (edge density) x 2 (alpha) = 16 trials per implementation; 16 trials x 0.5 min/trial x 25 implementations / 60 = 3.3 hours
...
Wrote HW4_simulation_plot.R, ran interactively 

### Question 3E

```{r, out.width = "600px"}
knitr::include_graphics("HW4_simulation_plot.png")
```

## Question 4

I am thinking of using the UWBiostat561 package to make a pkgdown website or writing a function for plots I am making for my RA. 
