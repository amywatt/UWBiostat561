...
- Data randomness: I will generate adj_mat of n = 10/25/50, clique fractions = 0.3/0.6/0.9, and edge densities = 0.3/0.6/0.9
- Methods: all 25 on canvas 
- I hope to see trends in methods that calculate the largest clique across the changing parameters 
- 3 trials per level outlined above. 
- 3x3x3 = 27 trials per implementation; 27 trials x 0.5 min/trial x 25 methods = 337.5 minutes 
